...
<rect width="49" height="44" fill="white" transform="translate(0.5 0.5)"/>
            ...
            <div class="text">
              ...
              <span class="subtitle">Palun muuda otsinguparameetreid</span>
            </div>
          </div>`;
...
<rect width="49" height="44" fill="white" transform="translate(0.5 0.5)"/>
            ...
            <div class="text">
              <span class="title">Me ei leidnud ühtegi pakkumist</span>
              <span class="subtitle">Otsime uusi pakkumisi teiste kuupäevadega, palun oota…</span>
            </div>
...
<rect width="49" height="44" fill="white" transform="translate(0.5 0.5)"/>
            ...
            <div class="text">
              <span class="title">Nendel kuupäevadel reise ei ole</span>
              <span class="subtitle">Vaata teisi reisipakkumisi</span>
            </div>
            
          </div>
           <div class="button-wrapper">
            <a href="https://www.coraltravel.ee/contact-us" target="_blank" class="contact-us">Saatke reisipäring</a>
            <span>või</span>
            <a href=${url} target="_blank" class="alt-search">Vaata teisi pakkumisi</a>
          </div>
          `;
...
function hideBanner(banner) {
  ...
  const offersDiv = document.querySelector(".offers-wrapper");
  const existingBanner = offersDiv.querySelector(`.${banner}-banner`);
